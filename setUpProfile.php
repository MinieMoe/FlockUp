            ...
            <div class="top-user-info">
                <div class="photos">
                    ...
                    <div class="user-avatar">
                        <img src="profileImg/defaultavatar.png" alt="user-avatar" id="avatar">
                ...
                <div class="description">
                    ...
                    <div class="link-and-education">
                        ...
                        <div class="common skills">
                            <input type="text" name="weblink" id="weblink" required placeholder="Enter weblink">
                        </div>
                        <div class="common skills">
                            <input  type="text" name="education" id="education" required placeholder="Enter your school">
                        </div>
                        <div class="skills">
